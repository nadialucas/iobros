...
#================================================#
ok <- subset(stamps_noweak, ringers == 2) 
...
# Now integrate
A = 1/integrate(function(x) (hr_bar_fun(x)/(1-Gm_fun(x))), lower = max(min(hr_bar$x), min(gm$x)), upper = max(gm$x)-.001)$value
print(A)
